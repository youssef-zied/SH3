...
export class NewUserPatient extends Component {
    constructor(){
        super()
        this.state={
            firstName:'',
...
<div className="jumbotron text-center">
                <h1>SkyHealth</h1>
                <p>Patient New User Registration</p> 
                <hr/>
            </div>
            ...
            <div className="form-row">
                <div className="form-group col-md-6">
                    <label htmlFor="National Id">Unique National Id (Identity Card or Passport)</label>
                    <input onChange={(e)=>this.handleChange(e)} type="text" className="form-control" id="nationalId" placeholder="Unique National Id"/>
                </div>
            </div>
